...
class NetatmoSecurityOutdoor extends IPSModule
{
    ...
    public function ApplyChanges()
    {
        ...
        $this->MaintainVariable('Event', $this->Translate('Last event'), VARIABLETYPE_STRING, '', $vpos++, true);
        $this->MaintainVariable('Notification', $this->Translate('Last notification'), VARIABLETYPE_STRING, '', $vpos++, true);
    ...
    public function MessageSink($TimeStamp, $SenderID, $Message, $Data)
    {
        ...
        if ($Message == IPS_KERNELMESSAGE && $Data[0] == KR_READY) {
            ...
            $this->CreatetMedia('Events' . $this->InstanceID, MEDIATYPE_DOCUMENT, $events_cached);
            $notifications_cached = $this->ReadPropertyBoolean('notifications_cached');
            $this->CreatetMedia('Notifications' . $this->InstanceID, MEDIATYPE_DOCUMENT, $notifications_cached);
        }
    }
...
/********************/
    ...
    public function CleanupVideoPath(bool $fulldebug = false)
    {
